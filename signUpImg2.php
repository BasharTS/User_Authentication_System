...
<head>
	...
	<script>
	    ...
	    function getImageSource(imageElement) {
	        ...
	        window.location.href = "signUpImg2.php?img=" + encodeURIComponent(imageSrc); 
							 ...
							 <?php
								...
								if(isset($_GET['img'])){
									...
									if(in_array($pass_image, $user_images)) {
								    	$_SESSION['result']['pass_img2'] = $pass_image;
								    	
								    	header("location: http://localhost/Graphical_System/signUpImg3.php");
								    }else{
