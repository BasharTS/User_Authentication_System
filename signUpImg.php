...
<head>
	...
	<script>
	    ...
	    function getImageSource(imageElement) {
	        ...
	        window.location.href = "signUpImg.php?img=" + encodeURIComponent(imageSrc); 
							 ...
							 <?php
								...
								if(isset($_GET['img'])){
									...
									if(in_array($pass_image, $user_images)) {
								    	$_SESSION['result']['pass_img1'] = $pass_image;
								    	header("location: http://localhost/Graphical_System/signUpImg2.php");
								    }else{
